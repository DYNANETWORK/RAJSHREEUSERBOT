...
""" =======================CONSTANTS====================== """
pm_caption = "  __**🔥🔥𝐑𝐀𝐉𝐒𝐇𝐑𝐄𝐄 𝐁𝐎𝐓  𝐈𝐒 𝐀𝐋𝐈𝐕𝐄🔥🔥**__\n\n"
...
pm_caption += f"┣•➳➠ `𝙾𝚆𝙽𝙴𝚁:` [𝚂𝙰𝙽𝚂𝙺𝙰𝚁𝙸](https://t.me/brokenn_starr)\n"
pm_caption += f"┗━━━━━━━━━━━━━━━━━━\n"
pm_caption += " [🔥𝐑𝐄𝐏𝐎🔥](https://github.com/Sanskari787898/RAJSHREEBOT) 🔹 [📜𝐋𝐢𝐜𝐞𝐧𝐬𝐞📜](https://github.com/Sanskari787898/RAJSHREEBOT/blob/main/LICENSE)"
...
async def amireallyalive(alive):
    ...
    ok = await borg.edit_message(alive.chat_id, on, file=file1) 
    ...
    await asyncio.sleep(edit_time)
    ok4 = await borg.edit_message(alive.chat_id, ok3, file=file1)
